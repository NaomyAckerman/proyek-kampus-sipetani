...
$harga = tampil("SELECT * FROM harga order by id_harga desc");

// tombol cariharga ditekan
if (isset($_POST['cariharga'])) {
  $harga = cariharga($_POST);
}
...
<head>
  ...
  <title>Taman Botani - Data Harga</title>
  ...
  <nav class="navbar navbar-expand navbar-dark static-top">
    ...
    <form action="" method="post" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
      <div class="input-group">
        <input type="text" class="form-control" placeholder="Cari..." autocomplete="off" aria-label="Search" aria-describedby="basic-addon2" name="keywordharga">
        <div class="input-group-append">
          <button class="btn btn-primary" type="submit" name="cariharga">
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <a href="tambahdataharga.php" class="btn btn-success mb-3">Tambah Data</a>
              <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center"><a href="hapusdataharga.php?id=<?= $data['id_harga']; ?>" onclick ="return confirm('Anda Yakin Ingin Menghapus Data Ini?');" class="btn btn-danger">Hapus</a> || <a href="editdataharga.php?id=<?=$data["id_harga"]; ?>" class="btn btn-warning">Ubah</a></td>
                  </tr>
                  <?php $n++; ?>
                  <?php endforeach; ?>  
                </tbody>
