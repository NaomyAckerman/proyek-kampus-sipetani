      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <a href="tambahdatapengunjung.php" class="btn btn-success mb-3">Tambah Data</a>
              <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center"><a href="hapus.php?id=<?=$data['id_pengunjung']; ?>" onclick ="return confirm('Anda Yakin Ingin Menghapus Data Ini?');" class="btn btn-danger">Hapus</a> || <a href="editdatapengunjung.php?id=<?=$data["id_pengunjung"]; ?>" class="btn btn-warning">Ubah</a></td>
                  </tr>
                  <?php $n++; ?>
                  <?php endforeach; ?>  
                </tbody>
