              ...
              <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $data["hari"]; ?></td>
                    <td><?= $data["harga"]; ?></td>
                    <td class="text-center"><a href="hapusdatahari.php?id=<?=$data['id_harga']; ?>" onclick ="return confirm('Anda Yakin Ingin Menghapus Data Ini?');" class="btn btn-danger">Hapus</a> || <a href="ubahharga.php?id=<?=$data["id_harga"]; ?>" class="btn btn-warning">Ubah</a> || <a href="tambahdataharga.php" class="btn btn-success">Tambah Data</a></td>
                  </tr>
                  <?php $n++; ?>
                  <?php endforeach; ?>  
                </tbody>
